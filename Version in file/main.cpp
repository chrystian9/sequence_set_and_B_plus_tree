    ...
    try{
        ...
        do{
            ...
            if(control == 1){
                ...
                sequence.CriaNovoTxt(true);
            }else if(control == 5){
                sequence.CriaNovoTxt(false);
            }else if(control == 6){
                leituraDoCSV(sequence, aux1, aux2, caso);
            }else if(control < 0 or control > 6){
...
void menuInicial(bool& caso){
    ...
    cout << "                       -> Versao Arvore B+ em arquivo <-                    " << endl << endl;
    if(caso){
...
void menuTratamento(int& control){
    ...
    cout << "* [4] - Cria novo Txt da Arvore B+" << endl;
    cout << "* [5] - Cria novo Txt do Sequence Set" << endl;
    cout << "* [6] - Realizar nova leitura do CSV" << endl;
